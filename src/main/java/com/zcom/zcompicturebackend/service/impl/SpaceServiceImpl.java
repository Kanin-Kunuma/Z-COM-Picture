...
import com.zcom.zcompicturebackend.manager.sharding.DynamicShardingManager;
import com.zcom.zcompicturebackend.model.dto.space.SpaceAddRequest;
import com.zcom.zcompicturebackend.model.dto.space.SpaceQueryRequest;
import com.zcom.zcompicturebackend.model.entity.Picture;
import com.zcom.zcompicturebackend.model.entity.Space;
import com.zcom.zcompicturebackend.model.entity.SpaceUser;
import com.zcom.zcompicturebackend.model.entity.User;
import com.zcom.zcompicturebackend.model.enums.SpaceLevelEnum;
import com.zcom.zcompicturebackend.model.enums.SpaceRoleEnum;
import com.zcom.zcompicturebackend.model.enums.SpaceTypeEnum;
...
import com.zcom.zcompicturebackend.mapper.SpaceMapper;
import com.zcom.zcompicturebackend.service.SpaceUserService;
...
* @createDate 2025-06-04 09:40:32
*/
@Service
...
/*    @Resource
    ...
    public void fillSpaceBySpaceLevel(Space space) {
        ...
        if (spaceLevelEnum != null) {
            // Q: 假设有一种情况, 管理员即指定了空间容量, 那先以哪个为主, 就是说空间级别是系统规定的, 其空间容量是固定的, 但管理员可根据级别来调节容量
            // A: 优先使用管理员的策略
