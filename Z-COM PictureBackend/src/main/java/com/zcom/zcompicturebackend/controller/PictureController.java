...
import com.zcom.zcompicturebackend.api.ailiyunai.model.GetOutPaintingTaskResponse;
import com.zcom.zcompicturebackend.api.imagesearch.ImageSearchApiFacade;
import com.zcom.zcompicturebackend.api.imagesearch.model.ImageSearchResult;
...
import com.zcom.zcompicturebackend.manager.auth.annotation.SaSpaceCheckPermission;
import com.zcom.zcompicturebackend.manager.auth.model.SpaceUserPermissionConstant;
...
/*                User loginUser = userService.getLoginUser(request);
        ...
        public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
            ...
            String cacheKey = "zcom:listPictureVOByPage:" + hashKey;
            // 1. 先从本地缓存中查询
            ...
            // 2. 若本地缓存未命中, 则要从 Redis 缓存中查询
            ValueOperations<String, String> valueOps = stringRedisTemplate.opsForValue();
            cachedValue = valueOps.get(cacheKey);

            if (cachedValue != null) {
                // 如果缓存命中, 需要更新本地缓存, 返回结果
