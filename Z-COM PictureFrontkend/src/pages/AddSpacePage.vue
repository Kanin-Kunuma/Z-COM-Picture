    ...
    <a-card title="空间级别介绍">
      <a-typography-paragraph>
        * 目前仅支持开通普通版，如需升级空间，请联系
        <a href="https://yuzu-soft.com" target="_blank">玛巴八个蛋</a>。
      </a-typography-paragraph>
...
import { SPACE_LEVEL_ENUM, SPACE_LEVEL_OPTIONS, SPACE_TYPE_MAP } from '@/constants/space'
...
const spaceType = computed(() => {
  if (route.query?.type) {
    ...
    return SPACE_LEVEL_ENUM.COMMON
  }
})
...
/**
 * 提交表单函数, 创建成功后会输出信息并跳转到新创建的空间详情页
 * @param values
 */
